...
const CallToAction = () => {
  return (
    <div className="relative py-24">
      ...
      <motion.div className="relative max-w-4xl xl:max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div>
            <p className="text-white mb-3">
              Discover a wide range of rental property in your location
            </p>
    ...
    <div className="relative py-24">
      ...
      >
        <div className="flex flex-col justify-between items-center">
          ...
          <div>
            <p className="text-white mb-3 text-start md:text-center">
